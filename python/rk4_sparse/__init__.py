...
try:
    ...
    rk4_sparse_eigen_cached = None  # type: ignore[assignment]
    rk4_sparse_eigen_direct_csr = None  # type: ignore[assignment]
    rk4_sparse_suitesparse = None  # type: ignore[assignment]
    benchmark_implementations = None  # type: ignore[assignment]
...
if os.environ.get("RK4_SPARSE_FAST", "0") in {"1", "true", "TRUE"} and fast is not None:
    try:
        from .fast import (
            rk4_sparse_eigen as _f_rk4_sparse_eigen,
            rk4_sparse_eigen_cached as _f_rk4_sparse_eigen_cached,
            rk4_sparse_eigen_direct_csr as _f_rk4_sparse_eigen_direct_csr,
        )
        rk4_sparse_eigen = _f_rk4_sparse_eigen  # type: ignore[assignment]
        rk4_sparse_eigen_cached = _f_rk4_sparse_eigen_cached  # type: ignore[assignment]
        rk4_sparse_eigen_direct_csr = _f_rk4_sparse_eigen_direct_csr  # type: ignore[assignment]
        # Optional backends
        try:
            from .fast import rk4_sparse_suitesparse as _f_rk4_sparse_suitesparse
            rk4_sparse_suitesparse = _f_rk4_sparse_suitesparse  # type: ignore[assignment]
        except Exception:
            pass
        try:
            from .fast import benchmark_implementations as _f_benchmark_implementations
            benchmark_implementations = _f_benchmark_implementations  # type: ignore[assignment]
        except Exception:
            pass
    except Exception:
